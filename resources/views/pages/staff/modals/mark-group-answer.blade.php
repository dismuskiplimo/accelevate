<div class="modal fade" id="mark-group-answer-{{ $answer->id }}">
  <div class="modal-dialog">
    <div class="modal-content">
      <form action="{{ route('staff.group.answer.mark', ['id' => $answer->id]) }}" method="POST">
        @csrf
        
        <div class="modal-header">
          <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
          <h4 class="modal-title">Mark Group Question Answer</h4>
        </div>
